        ...
        <div className="bg-white border-2 border-slate-200 rounded-3xl p-5 shadow-md space-y-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto shrink-0">
              <div className="flex items-center gap-1.5 bg-slate-100 p-1 border border-slate-300 rounded-xl text-xs flex-1 md:flex-initial">
                <span className="text-[11px] font-black text-slate-600 px-1.5 flex items-center gap-1">
                ...
                <select
                  ...
                  className="bg-white text-slate-900 font-extrabold text-xs py-1.5 px-2.5 rounded-lg border border-slate-300 focus:outline-none focus:border-purple-600 cursor-pointer"
                >
                  <option value="cp">⚡ PC (Puntos de Combate)</option>
                  <option value="pokedex">📖 Número Pokédex</option>
                  <option value="hp">❤️ Salud (PS)</option>
              ...
              <button
                ...
                className="px-3 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 font-black rounded-xl text-xs flex items-center gap-1.5 transition-all shadow-xs cursor-pointer"
              ...
              >
                {sortOrder === 'desc' ? (
                  <>
                    ...
                    <span className="hidden sm:inline">Desc (Mayor)</span>
                  </>
                ) : (
                  <>
                    <ArrowUp className="w-3.5 h-3.5 text-blue-600" />
                    <span className="hidden sm:inline">Asc (Menor)</span>
                  </>
                )}
              </button>
            </div>
